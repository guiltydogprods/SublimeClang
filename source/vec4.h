...
static const vec4i kMaskW = { 0xffffffff, 0xffffffff, 0xffffffff, 0 };
#endif
#else
...
static inline vec4 vec4_load(float* restrict address)
{
#ifdef RE_PLATFORM_WIN64
...
static inline void vec4_store(float* restrict address, const vec4 vec)
{
#ifdef RE_USE_SIMD
#ifdef RE_PLATFORM_WIN64
